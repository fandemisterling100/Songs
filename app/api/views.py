    ...
    def put(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            if song.created_by != current_user:
                return Response(
                    {
                        "Permission denied": "This song is private, you can not update it."
                    },
...
class SongDeleteApiView(generics.DestroyAPIView):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        if song.created_by != current_user:
            return Response(
                {"Permission denied": "This song is private, you can not delete it."},
                status=status.HTTP_400_BAD_REQUEST,
            )
...
class SongRetrieveAPIView(generics.RetrieveAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if song.created_by != current_user and song.private:
            return Response(
                {"Permission denied": "This song is private, you can not retrieve it."},
                status=status.HTTP_400_BAD_REQUEST,
            )
